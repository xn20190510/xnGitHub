...
(function () {
    ...
    Music.prototype = {
        ...
        _getUrl:function (isTryListen) {
            var me = this;
            var param = 'from=tiebasongwidget&url=&name=' + encodeURIComponent(me._removeHtml(selectedItem.xnTitle)) + '&artist='
        ...
        _renderTemplate:function (data) {
            ...
            for (var i = 0, tmpList; tmpList = data[i++];) {
                ...
                for (var j = 0, tmpObj; tmpObj = tmpList[j++];) {
                    ...
                    s.push('<span class="m-t">' + me._getMaxText(tmpObj.xnTitle) + '</span>');
