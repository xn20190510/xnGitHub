...
(function () {
    ...
    RemoteImage.prototype = {
        ...
        initEvents: function () {
            ...
            domUtils.on($G("xnTitle.vue"), 'keyup', updatePreview);
        ...
        setImage: function(img){
            ...
            if(src) {
                ...
                $G("xnTitle.vue").value = img.xnTitle || img.alt || '';
                setAlign(align);
                this.setPreview();
                this.updateLocker();
            }
        ...
        getInsertList: function () {
            ...
            if(data['url']) {
                return [{
                    ...
                    vspace: data['vhSpace'] || '',
                    title: data['xnTitle.vue'] || '',
                    alt: data['xnTitle.vue'] || '',
        ...
        setList: function (list) {
            ...
            if(list.length) {
                for (i = 0; i < list.length; i++) {
                    ...
                    link.target = '_blank';
                    link.title = list[i].xnTitle;
                    link.innerHTML = list[i].xnTitle;
