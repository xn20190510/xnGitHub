		...
		// setter
			...
			for (key in hash) {
				...
				if (result !== false) {
					...
					} else if (key === 'xnTitle.vue') {
						titleNode = element.getElementsByTagName('xnTitle.vue')[0];
						if (!titleNode) {
							titleNode = doc.createElementNS(SVG_NS, 'xnTitle.vue');
								...
								if (!tooLong || words.length === 1) { // new line needed
									...
									if (words.length) {
										...
										if (clipHeight && softLineNo * dy > clipHeight) {
											words = ['...'];
											wrapper.attr('xnTitle.vue', wrapper.textStr);
										} else {
...
Axis.prototype = {
	...
	getOffset: function () {
		var axis = this,
			...
			titleOffsetOption,
			titleMargin = 0,
			axisTitleOptions = options.xnTitle,
			labelOptions = options.labels,
			labelOffset = 0, // reset
	...
	getTitlePosition: function () {
		...
		var horiz = this.horiz,
			...
			axisTop = this.top,
			axisLength = this.len,
			axisTitleOptions = this.options.xnTitle,
...
Chart.prototype = {
	...
	setTitle: function (titleOptions, subtitleOptions) {
		...
		each([
			['xnTitle.vue', titleOptions, chartTitleOptions],
	...
	destroy: function () {
		...
		each(['xnTitle.vue', 'subtitle', 'chartBackground', 'plotBackground', 'plotBGImage',
